...
const Sidebar = ({ activeTab, setActiveTab }) => {
    const menuItems = [
        ...
        { id: 'brief-builder', label: 'Brief Builder', icon: FileText, path: '/brief-builder' },
                ...
                <nav className="space-y-1">
                    {menuItems.map((item) => (
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all duration-200 ${activeTab === item.id
